<!-- app/views/admin/add_departement.php -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <h2 class="text-center">Ajouter un département</h2>
        <?php if ($error): ?>
        ...
        <?php endif; ?>
        <form method="POST" action="<?php echo BASE_URL; ?>/admin/departements/add">
            <div class="form-group">
                <label for="nom">Nom du département</label>
                <input type="text" class="form-control" id="nom" name="nom" required>
            </div>
            <button type="submit" class="btn btn-primary btn-block">Ajouter le département</button>
        </form>
